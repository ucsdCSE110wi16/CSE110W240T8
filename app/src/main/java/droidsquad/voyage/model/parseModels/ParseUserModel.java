...
public class ParseUserModel extends ParseModel {
    ...
    private interface ParseUserField {
    ...
    public static User getUserFromParseUser(ParseUser parseUser) {
        return new User(
                ...
                parseUser.getString(ParseUserField.Facebook_ID),
                parseUser.getString(ParseUserField.FIRST_NAME),
                parseUser.getString(ParseUserField.LAST_NAME));
    }
